 ...
 */
final class Version20190313102942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_category (id INT AUTO_INCREMENT NOT NULL, categories_id INT DEFAULT NULL, products_id INT DEFAULT NULL, INDEX IDX_CDFC7356A21214B7 (categories_id), INDEX IDX_CDFC73566C8A81A9 (products_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
