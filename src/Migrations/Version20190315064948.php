 ...
 */
final class Version20190315064948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ordered_items (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, adress VARCHAR(100) NOT NULL, paid VARCHAR(255) NOT NULL, phone VARCHAR(50) NOT NULL, city VARCHAR(100) NOT NULL, user_email VARCHAR(100) NOT NULL, date DATETIME NOT NULL, INDEX IDX_DA06F504A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
